            ...
            <div class="row text-center clearfix">
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div id="contact-form-section">
                        ...
                        <form id="contact-form" class="contact" name="contact-form" method="post" action="login_check.php">
                           <div class="form-group">
                                <input onkeypress="return isNumberKey(event,this);" type="text" name="vuname" class="form-control input-lg " required="required" placeholder="User Name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                            <a href="report1.php" class="btn btn-primary">Sign_IN</a> 
