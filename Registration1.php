...
<div id="wrapper">
    ...
    <div class="row">
        <form action="add_data1.php" method="post" enctype="multipart/form-data">
            <div class="col-lg-8 col-lg-offset-1" style="margin-top: 10px;" >

                <div class="panel panel-green">
                    <div class="panel-heading">
                        <h3 class="panel-title">Visitor Registration</h3>
                    </div>
                    <div class="panel-body">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group has-success">
                                ...
                                <input onkeypress="return onlyAlphabets(event,this);" class="form-control input-lg" id="vname" name="vname" type="text" placeholder="Text here" required="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group has-success">
                                <label class="control-label" >Enter Username</label>
                                <input onkeypress="return onlyAlphabets(event,this);"  class="form-control input-lg" id="vuname" name="vuname" type="text" placeholder="Text here" required="">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group has-success">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group has-success">
                                ...
                                <input class="form-control input-lg" id="vemail" name="vemail" type="text" placeholder="Text here" >
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group has-success">
                                <label class="control-label" >Enter Date of Birth</label>
                                <input class="form-control input-lg" id="dob" name="dob" type="text" placeholder="Text here" required="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="form-group has-success">
                                ...
                                <input onkeypress="return isNumberKey(event,this);" class="form-control input-lg" id="vmno" name="vmno" type="text" placeholder="Text here" required="">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group has-success">
                      ...
                      <a  href="visitlog.php" class="btn btn-lg btn-warning pull-right">Submit </a>
